...
# protoc
  [![protoc status badge](https://sounkou-bioinfo.r-universe.dev/protoc/badges/version)](https://sounkou-bioinfo.r-universe.dev/protoc)

This package provides functions to download `protoc` and `protoc-go-gen` binaries and generate Go code from `.proto` files. This should be useful for R developers working with Protocol Buffers and Go.

For more information about Go support for Protocol Buffers, see the [golang/protobuf GitHub repository](https://github.com/golang/protobuf).
